...
const prodCascoUFO = {
    nombre: "Casco Moto Cross Enduro Ufo Onyx Rapture Winnersport",
    precio: 56000
};


const cascoUFO = document.getElementById('cascoUFO')

const h5 = document.getElementById('h5__card')
h5.className = "card1__h5"
h5.innerText = prodCascoUFO.nombre

const precio = document.getElementById('precio__card')
precio.className = "card1__precio"
precio.innerText = `$ ${prodCascoUFO.precio}`

cascoUFO.append(h5)
cascoUFO.append(precio)
